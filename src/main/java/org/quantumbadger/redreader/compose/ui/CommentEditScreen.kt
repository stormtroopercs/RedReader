...
import org.quantumbadger.redreader.navigation.CommentEditViewModel
    ...
    LaunchedEffect(state) {
        when (state) {
            is CommentEditViewModel.EditUiState.Success -> {
                ...
                ).let { org.quantumbadger.redreader.common.General.quickToast(context, it) }
                onDone()
            }

            is CommentEditViewModel.EditUiState.Error ->
                org.quantumbadger.redreader.common.General.quickToast(
                    context,
