...
abstract class JsonValue {
	...
	open fun <E : JsonDeserializable> asObject(clazz: Class<E>): E? = null
	...
	fun getAtPath(vararg keys: Any?): Optional<JsonValue> = getAtPathInternal(0, *keys)
	...
	companion object {
		...
		fun parse(source: InputStream?): JsonValue = parse(JsonFactory().createParser(source))
