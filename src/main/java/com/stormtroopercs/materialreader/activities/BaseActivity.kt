...
import com.stormtroopercs.materialreader.common.GlobalExceptionHandler.Companion.handleLastCrash
...
abstract class BaseActivity :
	 ...
	 */
	protected open fun baseActivityOnBackPressed(): Boolean = false
	 ...
	 */
	protected open fun baseActivityMustInterceptBack(): Boolean = false
	 ...
	 */
	protected open fun baseActivityConfiguresEdgeToEdge(): Boolean = true
	...
	companion object {
		 ...
		 */
		private fun osHandlesBackAnimations(): Boolean = Build.VERSION.SDK_INT >= Build.VERSION_CODES.BAKLAVA
	}
}
