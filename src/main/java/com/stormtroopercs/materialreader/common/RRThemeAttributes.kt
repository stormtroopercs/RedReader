...
import com.stormtroopercs.materialreader.common.PrefsUtility.AppearanceCommentHeaderItem
...
class RRThemeAttributes(context: Context) {
	...
	fun shouldShow(type: AppearanceCommentHeaderItem?): Boolean = mCommentHeaderItems.contains(type)
}
