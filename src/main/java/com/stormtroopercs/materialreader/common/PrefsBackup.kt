...
object PrefsBackup {
	...
	private val MAGIC_HEADER = "MaterialReader preferences backup\r\n".toByteArray(General.CHARSET_UTF8)
					...
					DataInputStream(
						...
						val doRestore = Runnable {
							...
							General.getSharedPrefs(activity)
								.performActionWithWriteLock(
									Consumer { sharedPrefs: SharedPreferences ->
	...
	private class MapReader(private val mMap: MutableMap<*, *>) {
		@Throws(IOException::class)
		fun getRequired(key: Any): Any = mMap.get(key)
